...
midi.findJammyPorts = () => {
  ...
  const jammyNames = ["MIDI function", "MIDI Gadget", "Jammy EVO", "Jammy E", "USB MIDI Device"];
...
midi.to16BitInt = (array, start) => {
  ...
  let hight = (hightResource1 === hightResource2) ? hightResource1 : ((hightResource1 << 1) | hightResource2);

  let low = (lowResource1 === lowResource2) ? lowResource1 : ((lowResource1 << 1) | lowResource2);
...
midi.to14BitInt = (array, start) => {
  ...
  let result = (hightResource1 === hightResource2) ? hightResource1 : ((hightResource1 << 1) | hightResource2);
